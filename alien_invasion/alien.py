...
class Alien(Sprite):
    ...
    def blitme(self):
        """ Desena o alienígena em sua posição atual """
        self.screen.blit(self.image, self.rect)

    
    def update(self):
        """ Move o alienígena para a direta ou para a esquerda"""
        self.x += (self.ai_settings.alien_spped_factor * self.ai_settings.fleet_direction)
        self.rect.x = self.x
