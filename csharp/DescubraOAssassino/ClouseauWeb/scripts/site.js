...
var urlBaseApi = 'http://localhost:25974/api/misterio/';
        ...
        success: function (response) {
            ...
            switch (retorno) {
                case 1:
                    ...
                    break;
                case 2: resposta = "Sua suposição está incorreta. Talvez você deva investigar mais sobre o local do crime.";
                    break;
                case 3: resposta = "Sua suposição está incorreta. Reexamine a arma do crime.";
                    break;
                default:
