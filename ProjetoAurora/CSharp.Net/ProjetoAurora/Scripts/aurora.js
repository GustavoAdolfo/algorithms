...
Aurora.lancarDados = function () {
    ...
    for (var i = 0; i < total; i++) {
        timeOut = window.setTimeout(Aurora.DadosEmJogo[i].jogar, 1500);
    }
...
Aurora.RegraPar.definirRegra(function () {
    ...
    if (Aurora.faces.seis >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.seis * 2);
    }
    else if (Aurora.faces.cinco >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.cinco * 2);
    }
    else if (Aurora.faces.quatro >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.quatro * 2);
    }
    else if (Aurora.faces.tres >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.tres * 2);
    }
    else if (Aurora.faces.dois >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.dois * 2);
    }
    else if (Aurora.faces.um >= 2) {
        Aurora.RegraPar.setPontos(Aurora.faces.um * 2);
    } else {
        Aurora.RegraPar.setPontos(0);
    }
});
...
Aurora.RegraDoisPares.definirRegra(function () {
    ...
    if (Aurora.faces.seis >= 2) {
        if (Aurora.faces.cinco >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.cinco * 2));
        }
        if (Aurora.faces.quatro >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.quatro * 2));
        }
        if (Aurora.faces.tres >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.tres * 2));
        }
        if (Aurora.faces.dois >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.dois * 2));
        }
        if (Aurora.faces.um >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.um * 2));
        }
    }
    else if (Aurora.faces.cinco >= 2) {
        if (Aurora.faces.quatro >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.quatro * 2));
        }
        if (Aurora.faces.tres >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.tres * 2));
        }
        if (Aurora.faces.dois >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.dois * 2));
        }
        if (Aurora.faces.um >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.um * 2));
        }
    }
    else if (Aurora.faces.quatro >= 2) {
        if (Aurora.faces.tres >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.tres * 2));
        }
        if (Aurora.faces.dois >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.dois * 2));
        }
        if (Aurora.faces.um >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.um * 2));
        }
    }
    else if (Aurora.faces.tres >= 2) {
        if (Aurora.faces.dois >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.dois * 2));
        }
        if (Aurora.faces.um >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.um * 2));
        }
    }
    else if (Aurora.faces.dois >= 2) {
        if (Aurora.faces.um >= 2) {
            Aurora.RegraDoisPares.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.um * 2));
        }
    } else {
...
Aurora.RegraTrio.definirRegra(function () {
    ...
    if (Aurora.faces.seis >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.seis * 3);
    }
    else if (Aurora.faces.cinco >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.cinco * 3);
    }
    else if (Aurora.faces.quatro >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.quatro * 3);
    }
    else if (Aurora.faces.tres >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.tres * 3);
    }
    else if (Aurora.faces.dois >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.dois * 3);
    }
    else if (Aurora.faces.um >= 3) {
        Aurora.RegraTrio.setPontos(Aurora.faces.um * 3);
    } else {
...
Aurora.RegraQuadra.definirRegra(function () {
    ...
    if (Aurora.faces.seis >= 3) {
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.seis * 3) + (Aurora.faces.cinco * 3));
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.seis * 3) + (Aurora.faces.quatro * 3));
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.seis * 3) + (Aurora.faces.tres * 3));
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.seis * 3) + (Aurora.faces.dois * 3));
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.seis * 3) + (Aurora.faces.um * 3));
        }
    }
    else if (Aurora.faces.cinco >= 3) {
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.cinco * 3) + (Aurora.faces.quatro * 3));
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.cinco * 3) + (Aurora.faces.tres * 3));
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.cinco * 3) + (Aurora.faces.dois * 3));
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.cinco * 3) + (Aurora.faces.um * 3));
        }
    }
    else if (Aurora.faces.quatro >= 3) {
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.quatro * 3) + (Aurora.faces.tres * 3));
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.quatro * 3) + (Aurora.faces.dois * 3));
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.quatro * 3) + (Aurora.faces.um * 3));
        }
    }
    else if (Aurora.faces.tres >= 3) {
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.tres * 3) + (Aurora.faces.dois * 3));
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.tres * 3) + (Aurora.faces.um * 3));
        }
    }
    else if (Aurora.faces.dois >= 3) {
        if (Aurora.faces.um >= 3) {
            Aurora.RegraQuadra.setPontos((Aurora.faces.dois * 3) + (Aurora.faces.um * 3));
        }
    } else {
...
Aurora.RegraFullHouse.definirRegra(function () {
    ...
    if (Aurora.faces.seis === 2) {
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.cinco * 3));
            return;
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.quatro * 3));
            return;
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.tres * 3));
            return;
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.dois * 3));
            return;
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.seis * 2) + (Aurora.faces.um * 3));
            return;
        }
    }
    else if (Aurora.faces.cinco === 2) {
        if (Aurora.faces.seies >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.seis * 3));
            return;
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.quatro * 3));
            return;
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.tres * 3));
            return;
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.dois * 3));
            return;
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.cinco * 2) + (Aurora.faces.um * 3));
            return;
        }
    }
    else if (Aurora.faces.quatro === 2) {
        if (Aurora.faces.seis >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.seis * 3));
            return;
        }
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.cinco * 3));
            return;
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.tres * 3));
            return;
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.dois * 3));
            return;
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.quatro * 2) + (Aurora.faces.um * 3));
            return;
        }
    }
    else if (Aurora.faces.tres === 2) {
        if (Aurora.faces.seis >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.seis * 3));
            return;
        }
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.cinco * 3));
            return;
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.quatro * 3));
            return;
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.dois * 3));
            return;
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.tres * 2) + (Aurora.faces.um * 3));
            return;
        }
    }
    else if (Aurora.faces.dois === 2) {
        if (Aurora.faces.seis >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.seis * 3));
            return;
        }
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.cinco * 3));
            return;
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.quatro * 3));
            return;
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.tres * 3));
            return;
        }
        if (Aurora.faces.um >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.dois * 2) + (Aurora.faces.um * 3));
            return;
        }
    }
    else if (Aurora.faces.um === 2) {
        if (Aurora.faces.seis >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.um * 2) + (Aurora.faces.seis * 3));
            return;
        }
        if (Aurora.faces.cinco >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.um * 2) + (Aurora.faces.cinco * 3));
            return;
        }
        if (Aurora.faces.quatro >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.um * 2) + (Aurora.faces.quatro * 3));
            return;
        }
        if (Aurora.faces.tres >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.um * 2) + (Aurora.faces.tres * 3));
            return;
        }
        if (Aurora.faces.dois >= 3) {
            Aurora.RegraFullHouse.setPontos((Aurora.faces.um * 2) + (Aurora.faces.dois * 3));
            return;
        }
    }
    else {
